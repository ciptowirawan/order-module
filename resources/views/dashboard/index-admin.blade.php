                ...
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                            Total Paid Registrants</div>
                        <div class="h5 mb-0 font-weight-bold text-gray-800">{{$totalPaidRegistrants}}</div>
                    </div>
                    <div class="col-auto">
                ...
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col-auto">
                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">{{$Lion}}</div>
                                </div>
                                <div class="col">
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col-auto">
                                <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">{{ $Leo }}</div>
                            </div>
                            <div class="col">
                                <div class="progress progress-sm mr-2">
                ...
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col-auto">
                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">{{$Adult}}</div>
                                </div>
                                <div class="col">
                                    <div class="progress progress-sm mr-2">
                ...
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-dark text-uppercase mb-1">
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col-auto">
                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">{{$A1}}</div>
                                </div>
                                <div class="col">
                                    <div class="progress progress-sm mr-2">
                                        <div class="progress-bar bg-dark" role="progressbar"
                                            style="width: {{$A1_percent . '%'}}" aria-valuenow="{{$A1_percent}}" aria-valuemin="0"
                                            aria-valuemax="100"></div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-dark text-uppercase mb-1">
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col-auto">
                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">{{$A2}}</div>
                                </div>
                                <div class="col">
                                    <div class="progress progress-sm mr-2">
                                        <div class="progress-bar bg-dark" role="progressbar"
                                            style="width: {{$A2_percent . '%'}}" aria-valuenow="{{$A2_percent}}" aria-valuemin="0"
                                            aria-valuemax="100"></div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-dark text-uppercase mb-1">
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col-auto">
                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">{{$B1}}</div>
                                </div>
                                <div class="col">
                                    <div class="progress progress-sm mr-2">
                                        <div class="progress-bar bg-dark" role="progressbar"
                                            style="width: {{$B1_percent . '%'}}" aria-valuenow="{{$B1_percent}}" aria-valuemin="0"
                                            aria-valuemax="100"></div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-dark text-uppercase mb-1">
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col-auto">
                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">{{$B2}}</div>
                                </div>
                                <div class="col">
                                    <div class="progress progress-sm mr-2">
                                        <div class="progress-bar bg-dark" role="progressbar"
                                            style="width: {{$B2_percent . '%'}}" aria-valuenow="{{$B2_percent}}" aria-valuemin="0"
                                            aria-valuemax="100"></div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-dark text-uppercase mb-1">
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col-auto">
                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">{{$Others}}</div>
                                </div>
                                <div class="col">
                                    <div class="progress progress-sm mr-2">
                                        <div class="progress-bar bg-dark" role="progressbar"
                                            style="width: {{$Others_percent . '%'}}" aria-valuenow="{{$Others_percent}}" aria-valuemin="0"
                                            aria-valuemax="100"></div>
                                    </div>
                                </div>
                            </div>
...
<div class="row">
    ...
    <div class="col-xl-4 col-lg-5">
        <div class="card shadow mb-4">
            ...
            <div
                class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold">Members Summary</h6>
                <div class="dropdown no-arrow">
                    <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink"
                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <i class="fas fa-ellipsis-v fa-sm fa-fw text-gray-400"></i>
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <h4 class="small font-weight-bold">Past Council Chairperson <span
                        class="float-right">{{$PCC . ' People'}}</span></h4>
                <div class="progress mb-4">
                ...
                <h4 class="small font-weight-bold">Past District Governor <span
                        class="float-right">{{$PDG . ' People'}}</span></h4>
                <div class="progress mb-4">
                ...
                <h4 class="small font-weight-bold">Region Chairperson <span
                        class="float-right">{{$RC . ' People'}}</span></h4>
                <div class="progress mb-4">
                ...
                <h4 class="small font-weight-bold">Zone Chairperson <span
                        class="float-right">{{$ZC . ' People'}}</span></h4>
                <div class="progress mb-4">
                ...
                <h4 class="small font-weight-bold">Club President <span
                        class="float-right">{{$CP . ' People'}}</span></h4>
                <div class="progress mb-4">
                ...
                <h4 class="small font-weight-bold">Club Secretary <span
                        class="float-right">{{$CS . ' People'}}</span></h4>
                <div class="progress mb-4">
                ...
                <h4 class="small font-weight-bold">Unknown Title <span
                        class="float-right">{{$unknownTitle . ' People'}}</span></h4>
                <div class="progress mb-4">
